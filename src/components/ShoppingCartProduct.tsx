...
export default function ShoppingCartProduct({ product, qty, onQuantityChange}) {
    ...
    <div className="flex flex-row items-center gap-4">
      ...
      <div className="ml-auto flex flex-col items-end gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="flex items-center gap-2 px-3 py-1 bg-red-300 text-white rounded hover:bg-red-400">
            {/* Icono SVG */}
            <svg
